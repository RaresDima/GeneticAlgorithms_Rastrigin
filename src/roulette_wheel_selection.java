...
public class roulette_wheel_selection {
    ...
    public static void main(String[] args){
        ...
        /**
         *   VARIABLE DECLARATION & INITIALIZATION + GENERATION 0 DISPLAY
         */
        ...
        double mutation_probability = 0.50,
               fittest_from_last_gen = 0.0,          // If the current generation is i, this is the fitness of the best indifidual from generation i-1
               fittest_from_next_to_last_gen = 0.0;  // and this is the fittest individual from i-2
        ...
        for (int generation = 0; generation < 100; ++generation){
            ...
            if(fittest_from_last_gen >= fittest_from_next_to_last_gen) {
            ...
            while (selected_population.size() < 17){
                ...
                if(random_generator.nextDouble() <= mutation_probability){
                    ...
                    selected_population.addElement(population.elementAt(select_best_individual(population)));

                    population.removeElement(select_best_individual(population));
                }
            }
            while (selected_population.size() > 17)
            ...
            //    8. POPULATION VECTOR AND ADAPTIVE PARAMETER ACTUATION
            population.clear();
            ...
            fittest_from_next_to_last_gen = fittest_from_last_gen;
            fittest_from_last_gen = population_eval.elementAt(select_best_individual(population));
        }
